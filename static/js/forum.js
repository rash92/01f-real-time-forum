                ...
                <div class="post">
                    <div class="tags-interactions">
                        <div class="post-tags">
                            ${item.Tags.map(
                              (tag) =>
                                `<a class="tag-link" onclick="renderCategory(${tag.TagName})">${tag.TagName}</a>`
                            ).join("")}
                        </div>
                        ${
                          ...
                          data.UserInfo.Permission === "moderator"
                            ...
                            <div class="post-interactions">
                                    <div class="tooltip">
                                        <button id="post-delete-button" class="delete-btn" name="deletepost" value="${
                                          item.UUID
                                        }">
